...
class ActivityModel extends CommonModel
{
    protected $_validate = array(
        ...
        array('start_time','checkStime','开始时间不能比当前时间前', 0, 'callback'),

        array('end_time', 'require', '结束时间不能为空', 0),
        array('end_time','checkStime','结束时间不能比当前时间前', 0, 'callback'),
        ...
        array('area','3,50','请输入3~50字节的活动地点',0,'length'),
        array('introduction','3,100','请输入3~100字节的活动介绍',0,'length'),
    ...
    protected $_auto = array(
        ...
        array('create_time',"getTimer",1,'callback'),
