...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-04-07 18:07:47
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
--
-- 转存表中的数据 `sise_auth_access`
--

INSERT INTO `sise_auth_access` (`role_id`, `rule_name`, `type`) VALUES
(2, 'user/indexadmin/default', 'admin_url'),
(2, 'adminadd/org/org_verify', 'admin_url'),
(2, 'protal/topic/topicadd', 'protal_url');
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='权限规则表' AUTO_INCREMENT=168 ;
...
(162, 'Admin', 'admin_url', 'admin/org/index', NULL, '组织用户审核', 1, ''),
(163, 'Admin', 'admin_url', 'admin/orgcontroller/index', NULL, '组织用户审核', 1, ''),
(164, 'Adminadd', 'admin_url', 'adminadd/orgcontroller/index', NULL, '组织用户审核', 1, ''),
(165, 'Adminadd', 'admin_url', 'adminadd/org/index', NULL, '组织用户审核', 1, ''),
(166, 'Adminadd', 'admin_url', 'adminadd/org/org_verify', NULL, '组织用户审核', 1, ''),
(167, 'Adminadd', 'admin_url', 'adminadd/topic/topic_verify', NULL, '组织用户管理', 1, '');
...
CREATE TABLE IF NOT EXISTS `sise_group` (
  ...
  `group_type` varchar(20) NOT NULL COMMENT '小组类型',
  `group_introduce` varchar(240) NOT NULL COMMENT '小组介绍',
  `group_notice` varchar(240) NOT NULL COMMENT '公告板',
  `group_tel` varchar(12) NOT NULL COMMENT '联系电话',
  `group_cover` varchar(50) DEFAULT NULL COMMENT '小组封面路径',
...
INSERT INTO `sise_group` (`group_id`, `group_name`, `group_type`, `group_introduce`, `group_notice`, `group_tel`, `group_cover`) VALUES
(1, '趣公益', '生态环保', '公告栏，公告栏，公告栏，公告栏，公告栏，公告栏，公告栏，公告栏，公告栏，公告栏，公告栏，公告栏，公告栏，公告栏，', '汇集各种有爱公益趣闻\r\n分享创意公益形式\r\n用爱攻占地球！\r\n温暖人类！\r\n治愈人心！\r\n\r\n注意：\r\n⑴止传播各种蓄意无证据的诋毁他人的行为\r\n⑵以下言论仅限个人意见立场，与本网站无关', '15014799147', '');
...
CREATE TABLE IF NOT EXISTS `sise_menu` (
  ...
  KEY `model` (`model`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='后台菜单表' AUTO_INCREMENT=164 ;
...
(119, 115, 'Admin', 'Route', 'add_post', '', 1, 0, '路由添加提交', '', '', 0),
...
(162, 163, 'Adminadd', 'Org', 'org_verify', '', 1, 1, '组织用户审核', '', '组织用户注册审核', 0),
(163, 0, 'Adminadd', 'Topic', 'topic_verify', '', 0, 1, '组织用户管理', 'th', '', 0);
...
(1, 'member_email_active', '{"title":"\\u5fd7\\u613f\\u8005-\\u8d26\\u53f7\\u6fc0\\u6d3b","template":"<p><br\\/><\\/p><p>&nbsp; &nbsp; \\u5c0a\\u656c\\u7684<span style=\\"FONT-SIZE: 16px; FONT-FAMILY: Arial; COLOR: rgb(51,51,51); LINE-HEIGHT: 18px; BACKGROUND-COLOR: rgb(255,255,255)\\">#username#\\uff0c\\u60a8\\u597d\\u3002<\\/span><\\/p><p>\\u5982\\u679c\\u60a8\\u662f\\u5fd7\\u613f\\u8005\\u7684\\u65b0\\u7528\\u6237\\uff0c\\u6216\\u5728\\u4fee\\u6539\\u60a8\\u7684\\u6ce8\\u518cEmail\\u65f6\\u4f7f\\u7528\\u4e86\\u672c\\u5730\\u5740\\uff0c\\u6211\\u4eec\\u9700\\u8981\\u5bf9\\u60a8\\u7684\\u5730\\u5740\\u6709\\u6548\\u6027\\u8fdb\\u884c\\u9a8c\\u8bc1\\u4ee5\\u907f\\u514d\\u5783\\u573e\\u90ae\\u4ef6\\u6216\\u5730\\u5740\\u88ab\\u6ee5\\u7528\\u3002<\\/p><p><br\\/>&nbsp; &nbsp; \\u60a8\\u53ea\\u9700\\u70b9\\u51fb\\u4e0b\\u9762\\u7684\\u94fe\\u63a5\\u5373\\u53ef\\u6fc0\\u6d3b\\u60a8\\u7684\\u5e10\\u53f7\\uff1a<\\/p><p><br\\/>&nbsp; &nbsp; <a title=\\"\\" href=\\"http:\\/\\/#link#\\" target=\\"_self\\">http:\\/\\/#link#<\\/a><\\/p><p><br\\/>&nbsp; &nbsp; (\\u5982\\u679c\\u4e0a\\u9762\\u4e0d\\u662f\\u94fe\\u63a5\\u5f62\\u5f0f\\uff0c\\u8bf7\\u5c06\\u8be5\\u5730\\u5740\\u624b\\u5de5\\u7c98\\u8d34\\u5230\\u6d4f\\u89c8\\u5668\\u5730\\u5740\\u680f\\u518d\\u8bbf\\u95ee)<\\/p><p>&nbsp; &nbsp; \\u611f\\u8c22\\u60a8\\u7684\\u8bbf\\u95ee\\uff0c\\u795d\\u60a8\\u4f7f\\u7528\\u6109\\u5feb\\uff01<br\\/><\\/p><p><br\\/><\\/p><p>&nbsp; &nbsp; \\u6b64\\u81f4<\\/p><p>&nbsp;&nbsp;&nbsp;\\u5fd7\\u613f\\u8005 \\u7ba1\\u7406\\u56e2\\u961f.<\\/p>"}', 1),
(3, 'cmf_settings', '{"banned_usernames":""}', 1),
(2, 'site_options', '{"site_name":"CXCL\\u5de5\\u4f5c\\u5ba4\\u4f5c\\u54c1-sise\\u6bd4\\u8d5b","site_host":"http:\\/\\/119.29.148.134\\/2016Sise","site_admin_url_password":"","site_tpl":"simplebootx","site_adminstyle":"flat","html_cache_on":"1","site_icp":"","site_admin_email":"haiku888@foxmail.com","site_tongji":"","site_copyright":"","site_seo_title":"CXCL\\u5de5\\u4f5c\\u5ba4\\u4f5c\\u54c1-sise\\u6bd4\\u8d5b","site_seo_keywords":"\\u534e\\u8f6f,sise,\\u7f51\\u8bbe,\\u6bd4\\u8d5b,CXCL\\u5de5\\u4f5c\\u5ba4","site_seo_description":"CXCL\\u5de5\\u4f5c\\u5ba4\\u4f5c\\u54c1-2016sise\\u6bd4\\u8d5b","urlmode":"0","html_suffix":"","comment_time_interval":60}', 1);
...
CREATE TABLE IF NOT EXISTS `sise_organization` (
  ...
  `admin_name` varchar(60) NOT NULL COMMENT '组织名称',
...
--
-- 转存表中的数据 `sise_organization`
--

INSERT INTO `sise_organization` (`org_id`, `users_id`, `admin_name`, `manager_name`, `org_type`, `apply_reason`) VALUES
(1, 17, '真实姓名', '组织name', '生态环保', '11111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111'),
(5, 23, '徐志', '组织名称namee', '生态环保', '申请原因');
...
(2, '组织者', NULL, 1, '可发布公益活动召集人马！', 1458995428, 1459236711, 0);
...
--
-- 转存表中的数据 `sise_role_user`
--

INSERT INTO `sise_role_user` (`role_id`, `user_id`) VALUES
(2, 14),
(2, 23);
...
CREATE TABLE IF NOT EXISTS `sise_route` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='url路由表' AUTO_INCREMENT=4 ;

--
-- 转存表中的数据 `sise_route`
--

INSERT INTO `sise_route` (`id`, `full_url`, `url`, `listorder`, `status`) VALUES
(3, 'user/register/index', 'register', 0, 1);
...
CREATE TABLE IF NOT EXISTS `sise_topic` (
  ...
  `topic_status` int(11) NOT NULL DEFAULT '0' COMMENT '0：待审核，1：审核通过，2：审核不通过',
  `user_id` int(11) NOT NULL,
  `topic_create` datetime NOT NULL,
...
INSERT INTO `sise_topic` (`topic_id`, `topic_title`, `topic_content`, `group_id`, `topic_status`, `user_id`, `topic_create`) VALUES
(5, '我是标题5', '<p>我是内容</p>', 1, 0, 1, '1899-11-30 00:00:00'),
(6, '我是标题2', '<p>我是内容………………</p>', 1, 0, 1, '0000-00-00 00:00:00'),
(7, '我是标题2', '<p>我是内容2222</p>', 1, 0, 1, '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `sise_users` (
  ...
  `user_status` int(11) NOT NULL DEFAULT '1' COMMENT '用户状态 0：禁用； 1：正常 ；2：未验证；3：未审核；4：审核不通过',
...
(1, 'admin', '###42e0497c116c196efa8dbabdc11a8569', 'admin', 'haiku888@foxmail.com', '', NULL, 0, NULL, NULL, '0.0.0.0', '2016-04-07 22:32:20', '2016-03-17 04:34:21', '2ea6119063aaca5bd9a5d8e98fd690ad', 1, 0, 1, 0, ''),
(24, '826037047_qq_com', '###f75c7169ebc8df5c5cfba4842f4b4104', '826037047_qq_com', '826037047@qq.com', '', NULL, 0, NULL, NULL, '172.16.174.33', '2016-04-02 19:09:59', '2016-04-02 19:09:59', 'a4cacdf7c19af7c50ee9348475228da1', 2, 0, 2, 0, ''),
(14, 'organ', '###c6b052057f6f76a53abafdaa40dfef06', '', 'organ@qq.com', '', NULL, 0, NULL, NULL, '0.0.0.0', '2016-03-29 11:40:08', '2016-03-29 15:29:05', '0b0633d665d6cb74f570d63ed709bbd0', 1, 0, 1, 0, ''),
(25, '842575435_qq_com', '###d7aa2eb4585f3a760e6c6cde16b802ca', '842575435_qq_com', '842575435@qq.com', '', NULL, 0, NULL, NULL, '0.0.0.0', '2016-04-07 11:14:11', '2016-04-04 01:18:39', '', 1, 0, 2, 0, ''),
(23, 'wewe@qq.com', '###d7aa2eb4585f3a760e6c6cde16b802ca', '', 'wewe@qq.com', '', NULL, 0, NULL, NULL, '0.0.0.0', '2016-04-05 20:13:23', '2016-04-01 14:36:03', 'b45371b6d093ae929d1af4e4d73dc6be', 1, 0, 1, 0, '15622283779'),
(30, '979987464_qq_com', '###d7aa2eb4585f3a760e6c6cde16b802ca', '979987464_qq_com', '979987464@qq.com', '', NULL, 0, NULL, NULL, '0.0.0.0', '2016-04-07 16:52:56', '2016-04-07 16:52:56', 'efb58a1f76008c451b421485a37a8af7', 2, 0, 2, 0, '');
