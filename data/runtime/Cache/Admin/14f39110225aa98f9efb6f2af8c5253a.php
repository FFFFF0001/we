...
<body>
	<div class="wrap">
		...
		<div class="home_info">
			<ul id="thinkcmf_notices">
				<li><img src="/2016Sise/admin/themes/simplebootx/Public/assets/images/loading.gif"style="vertical-align: middle;" /><span style="display: inline-block; vertical-align: middle;">加载中...</span></li>
			</ul>
		</div>
		...
		<div class="home_info" id="home_devteam">
			<ul>
				<li><em>CXCL工作室</em> <a href="http://www.CXCL工作室.com" target="_blank">www.CXCL工作室.com</a></li>
				<li><em><?php echo L('TEAM_MEMBERS');?></em> <span>徐智鹏，陈世滔，陈思爵，连远生</span></li>
			</ul>
		</div>
	</div>
	...
	<script>
		//获取官方通知
		$.getJSON("http://www.CXCL工作室.com/service/sms_jsonp.php?lang=<?php echo (LANG_SET); ?>&v=<?php echo (SIMPLEWIND_CMF_VERSION); ?>&callback=?",
		function(data) {
