...
<div class="">
 ...
 $effected_id=""; $filetpl="<a href='\$href' target='\$target'>\$label</a>"; $foldertpl="<a href='\$href' target='\$target' class='dropdown-toggle' data-toggle='dropdown'>\$label <b class='caret'></b></a>"; $ul_class="dropdown-menu" ; $li_class="" ; $style="nav"; $showlevel=6; $dropdown='dropdown'; echo sp_get_menu("main",$effected_id,$filetpl,$foldertpl,$ul_class,$li_class,$style,$showlevel,$dropdown); ?>
	...
	<!--通用头部开始-->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 register-welcome">
					<span class="welcome_img"></span>
					<h2>欢迎注册！</h2>
				</div>
			</div>
			<div class="row user_select">
				<div class="col-md-6 col-sm-12 col-xs-12 select">
					<img src="/2016Sise/themes/simplebootx/Public/css/image/user-pic.png" class="hidden-xs">
					<div class="select_content">
						<h3>个人用户</h3>
						<h6>注册成为志愿者加入好玩酷公益</h6>
                <a href="<?php echo U('User/register/primary_register');?>" class="select-btn">马上注册</a>
					</div>
				</div>
				<div class="col-md-6 col-sm-12 col-xs-12 select col-md-offset-1">
					<img src="/2016Sise/themes/simplebootx/Public/css/image/org-pic.png" class="hidden-xs">
					<div class="select_content">
						<h3>组织用户</h3>
						<h6>注册即可发布公益活动召集人马！</h6>
						<a href="<?php echo U('User/register/organization_register');?>" class="select-btn">马上注册</a>
					</div>
				</div>
			</div>
		</div>
