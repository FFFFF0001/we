...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('org/org_verify');?>">审核</a></li>
			<!--<li><a href="<?php echo U('AdminPage/add');?>"><?php echo L('PORTAL_ADMINPAGE_ADD');?></a></li>-->
		</ul>
		<form class="well form-search" method="post" action="<?php echo U('org/org_verify');?>">
			注册时间
		...
		<form class="js-ajax-form" method="post">
			<div class="table-actions">
				<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('org/agree');?>" data-subcheck="true" data-msg="你确定同意吗？">同意</button>
				<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('org/refuse');?>" data-subcheck="true" data-msg="<?php echo L('DELETE_CONFIRM_MESSAGE');?>">拒绝</button>
			...
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($posts)): foreach($posts as $key=>$vo): ?><tr>
					...
					<td class="table-oflow"><?php echo ($vo["manager_name"]); ?></td>
					<!--  <td>0</td> -->
					<td class="table-oflow"><?php echo ($vo["admin_name"]); ?></td>
					<td class="table-oflow"><?php echo ($vo["mobile"]); ?></td>
					<td class="table-oflow"><?php echo ($vo["org_type"]); ?></td>
					<td class="table-oflow"><p>
						<?php echo ($vo["apply_reason"]); ?>
					</p></td>
					<td>
						<a href="<?php echo U('org/agree',array('id'=>$vo['id']));?>">同意</a>|
						<a href="<?php echo U('org/refuse',array('id'=>$vo['id']));?>" class="js-ajax-delete">拒绝</a>
					</td>
			...
			<div class="table-actions">
				<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('org/agree');?>" data-subcheck="true" data-msg="你确定同意吗？">同意</button>
				<button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('org/refuse');?>" data-subcheck="true" data-msg="你确定删除吗？">拒绝</button>
			</div>
