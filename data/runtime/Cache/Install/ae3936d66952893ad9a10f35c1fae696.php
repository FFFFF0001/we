...
<link rel="stylesheet" href="/2016Sise/public/simpleboot/themes/flat/theme.min.css" />
<link rel="stylesheet" href="/2016Sise/public/install/css/install.css" />
<link rel="stylesheet" href="/2016Sise/public/simpleboot/font-awesome/4.4.0/css/font-awesome.min.css" />
...
<body>
	...
	<div class="version"><?php echo (SIMPLEWIND_CMF_VERSION); ?></div>
		...
		<section class="section">
			...
			<form id="js-install-form" action="/2016Sise/index.php?g=install&a=step4" method="post">
				...
				<div class="bottom text-center">
					<a href="/2016Sise/index.php?g=install&a=step2" class="btn btn-primary">上一步</a>
					<button type="submit" class="btn btn-primary">创建数据</button>
				</div>
			</form>
		</section>
		<script src="/2016Sise/public/js/jquery.js"></script>
		<script src="/2016Sise/public/js/validate.js"></script>
		<script src="/2016Sise/public/js/ajaxForm.js"></script>
		<script>
			function TestDbPwd() {
				...
				var url = "/2016Sise/index.php?g=install&a=testdbpwd";
				$.ajax({
					type : "POST",
					url : url,
					data : data,
